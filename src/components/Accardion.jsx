...
const AccordionItem = ({ title, children }) => {
  ...
  return (
    <div className="ml-2 pl-2 h-fit group relative">
      ...
      <AnimatePresence initial={false}>
        {isOpen && (
          <motion.div
            ...
            className="overflow-hidden pl-4 h-fit"
          >
            <div ref={contentRef} className="py-1 h-fit ">
              {children}
...
const Accordion = () => {
  return (
    <div
      className="w-3xl h-[300px] mx-auto mt-10 rounded-lg"
        ...
        <AccordionItem title="1-dars  ">
          <AccordionItem title="JavaScript nima?">
            <AccordionItem title="JavaScript nima ?-dasturlash tili ">
              <p className="text-sm text-gray-200 pl-12">
